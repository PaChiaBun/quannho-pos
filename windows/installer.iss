...
[Tasks]
Name: "desktopicon"; Description: "{hint:CreateDesktopIcon}"; GroupDescription: "{x}"; Flags: unchecked

[Files]
Source: "..\build\windows\runner\Release\{#MyAppExeName}"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\build\windows\runner\Release\*"; ExcludeSpecs: "{#MyAppExeName}"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
