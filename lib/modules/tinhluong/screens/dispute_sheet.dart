  ...
  Future<void> _submit() async {
    ...
    if (msg.isEmpty || msg.length > 500) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Vui lòng nhập nội dung (tối đa 500 ký tự)'),
    ...
    try {
      ...
      if (storeId == null || userId == null) {
        throw 'Không thể xác thực người dùng';
      }
      ...
      if (mounted) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text('Không thể gửi khiếu nại. Vui lòng thử lại.'),
            ...
            if (_success)
              ...
              SizedBox(
                ...
                child: ElevatedButton.icon(
                  ...
                  label: Text(
                    _loading ? 'Đang gửi...' : 'Gửi khiếu nại',
                    style: const TextStyle(
                      color: Colors.white,
                      fontWeight: FontWeight.w700,
                      fontSize: 15,
