...
class _AuthScreenState extends ConsumerState<AuthScreen>
  ...
  @override
  void dispose() {
    _loginPhoneCtrl.dispose(); _loginPassCtrl.dispose();
  ...
  Future<void> _login() async {
    ...
    if (result.isSuccess) {
      ...
      ref.read(sessionProvider.notifier).setSession(SessionData(
  ...
  void _showStoreCodeDialog(String code) {
    showDialog(
      ...
      builder: (_) => AlertDialog(
        ...
        title: const Text('Mã quán của bạn',
          style: TextStyle(color: Colors.white, fontWeight: FontWeight.w800)),
        content: Column(
          mainAxisSize: MainAxisSize.min,
          children: [
            const Text('Gửi mã này cho nhân viên để họ kết nối vào quán:',
            ...
            children: [
              ...
              Container(
                decoration: BoxDecoration(
                  ...
                  borderRadius: BorderRadius.circular(12)),
                child: Row(children: [
                  _TabBtn(label: 'Đăng nhập', active: _tab == 0,
                    onTap: () => setState(() { _tab = 0; _error = ''; })),
                  _TabBtn(label: 'Đăng ký', active: _tab == 1,
